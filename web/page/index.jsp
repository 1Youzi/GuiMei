...
<div class="layui-layout layui-layout-admin">
    ...
    <ul class="layui-nav layui-layout-right">
      <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
          <dd><a target="iframe_context" href="doStu?action=queryById&stuId=${sessionScope.Student.stuId}">基本资料</a>
          </dd>
      ...
      <ul id="left2" class="layui-nav layui-nav-tree" lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a target="iframe_context" href="doadmin?action=unionQuery&pageNumber=1&username">查询顾客</a>
            </dd>
          </dl>
        </li>
        <li class="layui-nav-item">
          ...
          <dl class="layui-nav-child">
            <dd><a target="iframe_context"
                   href="doStu?action=queryScore&pageNumber=1&orderBy=desc">大分类管理</a></dd>
  ...
  <div id="main" class="layui-body">
    ...
    <div style="padding: 15px;">
      ...
      <iframe name="iframe_context" frameborder="0" id="context"
              src="doStu?action=queryPageAll&pageNumber=1"></iframe>
    </div>
  </div>
